            ...
            <form class="frmlr" id="formulario">
                            ...
                            <div class="col">
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="rint" class="form-check-input" id="rint-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="llantat" class="form-check-input" id="llantat-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="puertat" class="form-check-input" id="puertat-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="rind" class="form-check-input" id="rind-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="llantad" class="form-check-input" id="llantad-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="puertad" class="form-check-input" id="puertad-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="retrovisor" class="form-check-input" id="retrovisor-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="stop" class="form-check-input" id="stop-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="direccional" class="form-check-input" id="direccional-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="luzr" class="form-check-input" id="luzr-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="luzp" class="form-check-input" id="luzp-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="carpa" class="form-check-input" id="carpa-si">
                        ...
                        <div class="col">
                            ...
                            <div class="col">
                                <div>
                                    <p class="text-center">RIN TRASERO</p>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="rintl" class="form-check-input" id="rintl-si">
                                ...
                                <div>
                                    <p class="text-center">LLANTA TRASERA</p>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="llantatl" class="form-check-input" id="llantatl-si">
                                ...
                                <div>
                                    <p class="text-center">PUERTA TRASERA</p>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="puertatl" class="form-check-input" id="puertatl-si">
                                ...
                                <div>
                                    <p class="text-center">RIN DELANTERO</p>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="rindl" class="form-check-input" id="rindl-si">
                                ...
                                <div>
                                    <p class="text-center">LLANTA DELANTERA</p>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="llantadl" class="form-check-input" id="llantadl-si">
                                ...
                                <div>
                                    <p class="text-center">PUERTA DELANTERA</p>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="puertadl" class="form-check-input" id="puertadl-si">
                                ...
                                <div>
                                    <p class="text-center">RETROVISOR</p>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="retrovisorl" class="form-check-input" id="retrovisorl-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="farol" class="form-check-input" id="farol-si">
                                ...
                                <div>
                                    <p class="text-center">DIRECCIONAL RH</p>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="direccionall" class="form-check-input" id="direccionall-si">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="PERSIANA" class="form-check-input" id="PERSIANA-si">
                ...
                <div class="row row-cols-2 mb-2">
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="techo" class="form-check-input" id="techo-si">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="portae" class="form-check-input" id="portae-si">
                ...
                <div class="row row-cols-3 mb-2">
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="sillac" class="form-check-input" id="sillac-si">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="sillap" class="form-check-input" id="sillap-si">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="sillat" class="form-check-input" id="sillat-si">
                ...
                <div class="row row-cols-2 mb-2">
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cinrh" class="form-check-input" id="cinrh-si">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cinlh" class="form-check-input" id="cinlh-si">
                ...
                <div class="row row-cols-2 mb-2">
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="caup" class="form-check-input" id="caup-si">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cajah" class="form-check-input" id="cajah-si">
                ...
                <div class="row row-cols-2 mb-2">
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="manm" class="form-check-input" id="manm-si">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="manl" class="form-check-input" id="manl-si">
                ...
                <div class="row row-cols-2 mb-2">
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="mana" class="form-check-input" id="mana-si">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cona" class="form-check-input" id="cona-si">
                ...
                <div class="row row-cols-1 row-cols-md-2 mb-3">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="seguro" class="form-check-input" id="seguro-si">
                ...
                <div class="row row-cols-1 row-cols-md-2 mb-3">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="tarjeta" class="form-check-input" id="tarjeta-si">
                ...
                <div class="row row-cols-1 row-cols-md-2 mb-3">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="segc" class="form-check-input" id="segc-si">
                ...
                <div class="row row-cols-1 row-cols-md-2 mb-3">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="sege" class="form-check-input" id="sege-si">
                ...
                <div class="row row-cols-1 row-cols-md-2 mb-3">
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="Revtec" class="form-check-input" id="Revtec-si">
                ...
                <div class="row row-cols-2  mb-2">
                    ...
                    <div>
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" name="conf" class="form-check-input" id="conf-si">
