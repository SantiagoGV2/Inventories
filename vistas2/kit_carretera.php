                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="gato" class="form-check-input"
                                        id="gato-bien">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="señales" class="form-check-input"
                                        id="señales-bien">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="herramientas" class="form-check-input"
                                        id="herramientas-bien">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Llanta" class="form-check-input"
                                        id="Llanta-bien">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Chaleco" class="form-check-input"
                                        id="Chaleco-bien">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Botiquin" class="form-check-input"
                                        id="Botiquin-bien">
