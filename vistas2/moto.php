                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Licencia" class="form-check-input"
                                        id="Licencia-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-4 mb-2">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="cne" class="form-check-input"
                                        id="cne-si">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="debIdn" class="form-check-input"
                                        id="debIdn-si">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="gbe" class="form-check-input"
                                        id="gbe-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="ubca" class="form-check-input"
                                        id="ubca-si">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="gube" class="form-check-input"
                                        id="gube-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="impermeable" class="form-check-input"
                                        id="impermeable-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Retrovisores" class="form-check-input"
                                        id="Retrovisores-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Pito" class="form-check-input"
                                        id="Pito-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Comando" class="form-check-input"
                                        id="Comando-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Direccionales" class="form-check-input"
                                        id="Direccionales-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Luz" class="form-check-input"
                                        id="Luz-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="LuzF" class="form-check-input"
                                        id="LuzF-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Amortiguadores" class="form-check-input"
                                        id="Amortiguadores-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Mofle" class="form-check-input"
                                        id="Mofle-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="FrenoT" class="form-check-input"
                                        id="FrenoT-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="LlantaRin" class="form-check-input"
                                        id="LlantaRin-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="CadenaTens" class="form-check-input"
                                        id="CadenaTens-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="Fuga" class="form-check-input"
                                        id="Fuga-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="FrenoD" class="form-check-input"
                                        id="FrenoD-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="LlantaRd" class="form-check-input"
                                        id="LlantaRd-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="AmortiguadoresD" class="form-check-input"
                                        id="AmortiguadoresD-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="LuzD" class="form-check-input"
                                        id="LuzD-si">
