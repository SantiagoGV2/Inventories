<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle">Asignar herramienta</h2>
</div>
...
<div class="container pb-6 pt-6">
	...
	<form action="./php2/her_emple_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data" >
		<div class="columns">
		  	<div class="column">
