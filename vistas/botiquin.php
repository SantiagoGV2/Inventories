                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="baja" class="form-check-input" id="baja-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="guantes" class="form-check-input" id="guantes-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="venda" class="form-check-input" id="venda-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="venda3x5" class="form-check-input" id="venda3x5-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="venda5x5" class="form-check-input" id="venda5x5-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="yodo" class="form-check-input" id="yodo-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="solucion" class="form-check-input" id="solucion-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="termometro" class="form-check-input" id="termometro-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="alcohol" class="form-check-input" id="alcohol-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="linterna" class="form-check-input" id="linterna-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="pilas" class="form-check-input" id="pilas-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="tijera" class="form-check-input" id="tijera-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="manual" class="form-check-input" id="manual-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="algodon" class="form-check-input" id="algodon-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="cura" class="form-check-input" id="cura-bien">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-3">
                    <div class="col ">
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="tapabocas" class="form-check-input" id="tapabocas-bien">
