                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="tejido" class="form-check-input"
                                        id="tejido-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="fecd" class="form-check-input"
                                        id="fecd-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="crtc" class="form-check-input"
                                        id="crtc-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="fisura" class="form-check-input"
                                        id="fisura-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="esex" class="form-check-input"
                                        id="esex-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="detege" class="form-check-input"
                                        id="detege-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="cdeapq" class="form-check-input"
                                        id="cdeapq-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="quemfd" class="form-check-input"
                                        id="quemfd-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="decolor" class="form-check-input"
                                        id="decolor-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="moho" class="form-check-input"
                                        id="moho-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="cort" class="form-check-input"
                                        id="cort-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 " id="costrras">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="deshil" class="form-check-input"
                                        id="deshil-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="hilofal" class="form-check-input"
                                        id="hilofal-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="quema" class="form-check-input"
                                        id="quema-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="expq" class="form-check-input"
                                        id="expq-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="defdo" class="form-check-input"
                                        id="defdo-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="picgri" class="form-check-input"
                                        id="picgri-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="presdes" class="form-check-input"
                                        id="presdes-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="corox" class="form-check-input"
                                        id="corox-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="clec" class="form-check-input"
                                        id="clec-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Deformaciones (dobladuras,etc)</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="defmo" class="form-check-input"
                                        id="defmo-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="bmcs" class="form-check-input"
                                        id="bmcs-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="gripi" class="form-check-input"
                                        id="gripi-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="redefa" class="form-check-input"
                                        id="redefa-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="frepru" class="form-check-input"
                                        id="frepru-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Deterioro general.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="degemo" class="form-check-input"
                                        id="degemo-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="corromo" class="form-check-input"
                                        id="corromo-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 ">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Presencia de moho.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="premoh" class="form-check-input"
                                        id="premoh-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="fecdds" class="form-check-input"
                                        id="fecdds-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Cortes o rotura del tejido o costuras</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="corrottej" class="form-check-input"
                                        id="corrottej-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="ajmosci" class="form-check-input"
                                        id="ajmosci-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="estiex" class="form-check-input"
                                        id="estiex-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">deformaciones (dobladuras, etc.)</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="defordoesl" class="form-check-input"
                                        id="defordoesl-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Quemaduras o fibras derretidas</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="quemesl" class="form-check-input"
                                        id="quemesl-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="padbidec" class="form-check-input"
                                        id="padbidec-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="corrometal" class="form-check-input"
                                        id="corrometal-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Presencia de moho</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="presmoho" class="form-check-input"
                                        id="presmoho-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="presusqui" class="form-check-input"
                                        id="presusqui-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Cuenta con la etiqueta de certificación.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="cueneticer" class="form-check-input"
                                        id="cueneticer-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Fibras externas cortadas, desgastadas y desgarradas</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="fecdeslp" class="form-check-input"
                                        id="fecdeslp-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="crtceslp" class="form-check-input"
                                        id="crtceslp-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Ajuste de los mosquetones en cierres de seguridad</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="amcseslp" class="form-check-input"
                                        id="amcseslp-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Estiramiento excesivo</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="eexeslp" class="form-check-input"
                                        id="eexeslp-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">deformaciones (dobladuras, etc.)</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="defeslp" class="form-check-input"
                                        id="defeslp-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Quemaduras o fibras derretidas.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="quemfeslp" class="form-check-input"
                                        id="quemfeslp-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Puntos o áreas duras o brillantes indican daño por exposición al calor o a radiación UV</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="padbeslp" class="form-check-input"
                                        id="padbeslp-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Corrosión en partes metálicas</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="cpmeslp" class="form-check-input"
                                        id="cpmeslp-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Presencia de moho</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="pmeslp" class="form-check-input"
                                        id="pmeslp-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Presencia de sustancias químicas en partes metálicas y en las reatas.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="psqpmeslp" class="form-check-input"
                                        id="psqpmeslp-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Cuenta con la etiqueta de certificación.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="cdceslp" class="form-check-input"
                                        id="cdceslp-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Deformaciones (dobladuras,etc)</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="deflv" class="form-check-input"
                                        id="deflv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Picaduras o grietas</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="picgrilv" class="form-check-input"
                                        id="picgrilv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Presenta desgaste</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="pdeslv" class="form-check-input"
                                        id="pdeslv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">corrosión u oxidación.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="corrooxilv" class="form-check-input"
                                        id="corrooxilv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Fibras externas cortadas, desgastadas y desgarradas.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="fecdlv" class="form-check-input"
                                        id="fecdlv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Cortes o rotura del tejido o costuras.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="crtclv" class="form-check-input"
                                        id="crtclv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Ajuste de los mosquetones en cierres de seguridad.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="amcslv" class="form-check-input"
                                        id="amcslv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Estiramiento excesivo.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="estiexlv" class="form-check-input"
                                        id="estiexlv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Quemaduras o fibras derretidas.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="quemfiblv" class="form-check-input"
                                        id="quemfiblv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Puntos o áreas duras o brillantes indican daño por exposición al calor o a radiación UV.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="padbidecrlv" class="form-check-input"
                                        id="padbidecrlv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">corrosión en partes metálicas</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="corromelv" class="form-check-input"
                                        id="corromelv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Presencia de moho.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="pmoholv" class="form-check-input"
                                        id="pmoholv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Presencia de sustancias químicas en partes metálicas y en las reatas..</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="psquimlv" class="form-check-input"
                                        id="psquimlv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Cuenta con la etiqueta de certificación.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="etiquetalv" class="form-check-input"
                                        id="etiquetalv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="pavmlv" class="form-check-input"
                                        id="pavmlv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Cuenta con la etiqueta de certificación.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="ccelv" class="form-check-input"
                                        id="ccelv-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Presenta desgaste</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="pdms" class="form-check-input"
                                        id="pdms-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Fibras externas cortadas, desgastadas y desgarradas</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="fecdms" class="form-check-input"
                                        id="fecdms-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Cortes o rotura del tejido o costuras.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="crtcms" class="form-check-input"
                                        id="crtcms-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Quemaduras o fibras derretidas</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="quemfdms" class="form-check-input"
                                        id="quemfdms-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Presencia de moho</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="pmohoms" class="form-check-input"
                                        id="pmohoms-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-3">
                        ...
                        <div class="col">
                            <div>
                                <p class="text-center">Cuenta con la etiqueta de certificación.</p>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="ccems" class="form-check-input"
                                        id="ccems-si">
