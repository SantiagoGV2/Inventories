...
<div class="container mt-4">
        <div class="row">
            <div id="content" class="col">
                <h3>INSPECCION DOTACION</h3>
                <hr>
                <form class="frmlr" id="formulario">  
                    <h6 class="text-center">Informacion del trabajador</h6>
                    <hr>
                    <div class="row row-cols-1 row-cols-md-2 mb-2">
                        <div class="col">
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" id="nombreDota" placeholder=".">
                                <label for="nombreDota">Nombre</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-floating mb-2">
                                <input type="date" class="form-control" id="fechaDota" placeholder=".">
                                <label for="fechaDota">Fecha</label>
                            </div>
                        </div>
                    </div>
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col">
                            <div class="form-floating mb-2">
                                <input type="number" class="form-control" id="numiden" placeholder=".">
                                <label for="numiden">No. identificacion</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" id="cargoTabajo" placeholder=".">
                                <label for="cargoTabajo">Cargo</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" id="ciudadT" placeholder=".">
                    ...
                    <hr>
                    <h6 class="text-center">Entraga de dotacion y elementos de proteccion personal</h6>
                    <hr>
                    <br>
                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="lentes" class="form-check-input"
                                        id="lentes-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="lsc" class="form-check-input"
                                        id="lsc-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="tapa" class="form-check-input"
                                        id="tapa-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="protector" class="form-check-input"
                                        id="protector-si">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 mb-2">
                        <div class="col ">
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="respirador" class="form-check-input"
                                        id="respirador-si">
